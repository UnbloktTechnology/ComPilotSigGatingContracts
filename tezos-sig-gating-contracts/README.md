...
The _nft minter_ contract has been deployed
...
A local network (called _sandbox_) can be used for testing before deployment on Testnet.
...
The following command invoke the `Exec_gated_calldata` entrypoint of the `NftMinter` contract.
