...
import { convert_timestamp, convert_key, convert_nat, convert_string, convert_address, convert_chain_id, convert_mint } from './convert';
...
export const signTxAuthDataLibTezos = async (
  ...
  client: RpcClient
    ...
    const nonce = await getNonceFromContract(tezosTxAuthInput.contractAddress, tezosTxAuthInput.userAddress, provider);
