...
import type {
  ...
  CredentialAtomicQueryValidatorInterface,
} from "../CredentialAtomicQueryValidator";
...
export class CredentialAtomicQueryValidator__factory {
  static readonly abi = _abi;
  static createInterface(): CredentialAtomicQueryValidatorInterface {
    return new utils.Interface(_abi) as CredentialAtomicQueryValidatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as CredentialAtomicQueryValidator;
  }
}
