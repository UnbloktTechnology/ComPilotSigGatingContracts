...
interface NexeraZKPVerifierInterface extends ethers.utils.Interface {
  functions: {
...
export class NexeraZKPVerifier extends BaseContract {
  ...
  interface: NexeraZKPVerifierInterface;
