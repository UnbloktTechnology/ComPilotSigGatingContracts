 ...
 * @dev
 */
contract TxAuthDataVerifierFacetStorage {
    bytes32 internal constant STORAGE_SLOT = keccak256("nexeraId.NexeraIdSigGating.storage.TxAuthDataVerifierFacetStorage");
