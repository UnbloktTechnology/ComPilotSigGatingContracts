...
const BNB_TESTNET_PROVIDER_URL =
  process.env.SEPOLIA_PROVIDER_URL || getRpcUrl(NEXERA_CHAINS.BNB_TESTNET);
const OPTIMISM_SEPOLIA_PROVIDER_URL =
  process.env.SEPOLIA_PROVIDER_URL || getRpcUrl(NEXERA_CHAINS.OPTIMISM_SEPOLIA);
const BASE_SEPOLIA_PROVIDER_URL =
  process.env.SEPOLIA_PROVIDER_URL || getRpcUrl(NEXERA_CHAINS.BASE_SEPOLIA);
const AVALANCHE_FUJI_PROVIDER_URL =
  process.env.SEPOLIA_PROVIDER_URL || getRpcUrl(NEXERA_CHAINS.AVALANCHE_FUJI);
const ARBITRUM_SEPOLIA_PROVIDER_URL =
  process.env.SEPOLIA_PROVIDER_URL || getRpcUrl(NEXERA_CHAINS.ARBITRUM_SEPOLIA);
